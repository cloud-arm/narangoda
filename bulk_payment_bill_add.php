...
if ($error_id == "m") {
  ...
  $sql = "INSERT INTO credit_payment (tr_id,sales_id,pay_id,pay_amount,credit_amount,cus_id,date,action,cus,type,collection_id,invoice_no) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
  $q = $db->prepare($sql);
  $q->execute(array($invo, $sales_id, $pay_id, $amount, $c_amount, $cus_id, $date, $act, $cus, $type, $coll_id, $invoice_no));
