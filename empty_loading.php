...
<body class="hold-transition skin-yellow sidebar-mini">
  ...
  $_SESSION['SESS_FORM'] = 'empty_loading';
        ...
        <div class="col-md-8">
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <form method="POST" action="empty_loading_2.php">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Yard</label>
                      <select class="form-control select2 hidden-search" name="yard" style="width:100%;" autofocus>
