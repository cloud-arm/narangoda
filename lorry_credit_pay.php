          ...
          <div class="col-md-10">
            <form name="myForm" onsubmit="return validateForm()" action="lorry_credit_pay_save.php" method="post">
              ...
              <div class="form-group" id='chq_pay' style="display:none;">
                ...
                <div class="input-group">
                  <input type="text" name="bank" id="bank" class="form-control pull-right">
                  <p id="bank1" style="color: red"></p>
                </div>
                <label for="exampleInputPassword1">Amount</label>
                <div class="input-group">
                  <input type="text" name="chq_amount" class="form-control pull-right" id="chq_amount" autocomplete="off">
                  <p id="chq_amount1" style="color: red"></p>
                </div>
                <label for="exampleInputPassword1">Date</label>
                <div class="input-group">
                  <input type="text" name="chq_date" class="form-control pull-right" id="chq_date" autocomplete="off" data-inputmask='"mask": "9999-99-99"' data-mask>
                  <p id="chq_date1" style="color: red"></p>
                </div>
                <br>
